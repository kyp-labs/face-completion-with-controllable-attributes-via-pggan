...
class FaceGen():
    ...
    def __init__(self):
        ...
        self.G = Generator(dataset_shape,
                           ...
                           fmap_decay=config.train.net.fmap_decay,
    ...
    def train(self):
        ...
        for R in range(from_resol, max_resol+1):
            ...
            while cur_it <= total_it:
                for i_batch, sample_batched in enumerate(self.training_set):
